  ...
  $sfname = $_POST['sfname'];
    ...
    $abc=md5($_POST['password']);
        ...
        while($row = mysqli_fetch_array($user_check_rslt)){
            //echo $row['type_id'];
        $type = $row['type_id'];
        $user_reg = "INSERT INTO `tbl_parent`(`adn_no`, `fname`, `lname`, `sfname`, `address`, `relationship`, `email`, `phone`, `password`) VALUES ('$adn_no','$fname','$lname','$sfname','$address','$relationship','$email','$phone','$abc'
            )";
...
<select   name="adn_no" onchange="showResult(this.value)" class="form-control"  >
...
?>
        ...
        <div class="col-12">
          <label>First Name</label>
            <input type="text" name="fname" class="form-control" placeholder="Enter first name" id="fname"  title="Name must be alphabets"  required onkeyup="return Validate()" onblur="return Validate()" required/>
          ...
          <label>Last  Name</label>
            ...
            id="lname" placeholder="Enter last name"  title="Name must be alphabets" onblur="return Validatename()" required onkeyup="return Validatename()" required/>
...
<select   name="sfname" onchange="showResult(this.value)" class="form-control"  >
<!-- <option value="">--select--</option> -->
<?php
while($row=mysqli_fetch_array($sql))
{
...
?>
<option value="<?php echo $row[1] ?>" ><?php echo $row[1] ?></option>s
...
<!--                                                    <h4 style="color:rgb(249, 164, 61) ;">Password must contain the following:</h4>-->
          ...
          <label>Confirm Password</label>
            <input type="password" name="cpassword" class="form-control" placeholder="confirm password"  id="cpassword" required onkeyup="return Confirmpass()" onblur="return Confirmpass()"  required/>
