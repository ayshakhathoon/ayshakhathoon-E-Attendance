...
$adn_no=$_SESSION['adn_no'];
  $query = "SELECT * FROM tbl_class WHERE class_id = (SELECT class_id FROM tbl_teacher 
    WHERE t_id = '$adn_no')";
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">class_id <span class="text-danger">*</span></label>
              <div class="col-md-8">
                <?php 
                echo '<label>'.$row["class_id"].'</label>';
                ?>
              </div>
            </div>
          </div>
          ...
          ?>
                <tr>
                  <td><?php echo $student["adn_no"]; ?></td>
                  <td>
                    <?php echo $student["fname"]; ?>
                    <input type="hidden" name="fname" value="<?php echo $student["adn_no"]; ?>" />
                  </td>
                  <td align="center">
                    <input type="radio" name="attendance_status<?php echo $student["adn_no"]; ?>" value="Present" />
                  </td>
                  <td align="center">
                    <input type="radio" name="attendance_status<?php echo $student["adn_no"]; ?>" checked value="Absent" />
                  </td>
                </tr>
          <?php
          }
...
<div class="modal" id="reportModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal footer -->
      <div class="modal-footer">
        <input type="hidden" name="adn_no" id="adn_no" />
