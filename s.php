  ...
  $class_id= $_POST['class_id'];
    ...
    $abc=md5($_POST['password']);
        ...
        while($row = mysqli_fetch_array($user_check_rslt)){
            //echo $row['type_id'];
        $type = $row['type_id'];
        $user_reg = "INSERT INTO `tbl_stud`(`fname`, `lname`,`class_id`, `dob`,  `gender`, `address`, `email`, `phone`, `password`) VALUES ('$fname','$lname','$class_id','$dob','$gender','$address','$email','$phone','$abc'
            )";
  ...
  <div class="col-12 p-5">
    <div class="row">
      ...
      <label>Last  Name</label>
            <input type="text" class="form-control" name="lname" id="lname" placeholder="Enter last name"  title="Name must be alphabets"  required onkeyup="return Validatename()" onblur="return Validatename()" required >
...
<select   name="class_id" onchange="showResult(this.value)" class="form-control"  >
</div>
<br>
...
<select name="gender"   class="form-control"> >
	...
	<option value="female">Female</option>
      ...
      <div class="col-12">
          ...
          <label>Email</label>
            <input type="text"  class="form-control" name="email" placeholder="Enter mail" id="email"   required onkeyup="return ValidateEmail()" onblur="return ValidateEmail()">
